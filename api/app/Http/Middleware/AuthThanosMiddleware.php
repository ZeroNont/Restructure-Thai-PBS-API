...
class AuthThanosMiddleware
{

    private const ACTOR_ALLOW = ['THANOS'];
    ...
    public function handle($request, Closure $next)
    {
        ...
        try {
            ...
            if ($auth->iss != env('APP_NAME') || !in_array($auth->actor_code, self::ACTOR_ALLOW) || $request->header('Thanos-Key') !== env('THANOS_KEY')) {
                throw new Exception();
            }
