                        ...
                        <tr>
                            <td valign="top" style="padding-top: 16px;">
                                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%"
                                    style="margin:0 auto;">
                                    <tr>
                                        <td><span class="headline">เรียนคุณ {{ $data['to'] }}</span></td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 10px;">
                                            <span class="description"
                                                style="margin-top: 10px;">ท่านได้ถูกรับเชิญให้เข้าร่วมการประชุมโดยใช้งานระบบการจัดการประชุม
                                    ...
                                    <tr>
                                        <td style="padding-top: 10px;">
                                            <a href="{{ $data['url'] }}"
                                                ...
                                                role="button">ยืนยันตัวตน</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 10px;"><span class="danger-description"
                                                style="margin-top: 10px;">*
                                                กรุณาทำการยืนยันตัวตนก่อน{{ $data['before'] }}</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="margin: 0 auto; padding: 0 16px 16px 16px;" cellpadding="0"
                                                cellspacing="0" width="100%" bgcolor="#F2F4F8">
                                                <tr>
                                                    <td width="50"><span class="description">ติดต่อ</span></td>
                                                    <td><span class="description"> : 1350</span></td>
                                                </tr>
                                                <tr>
